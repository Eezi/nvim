...
vim.keymap.set("n", "<leader>c", require('telescope.builtin').git_status, { desc = '[S]earch by [G]status' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'tsx', 'vimdoc', 'vim', "astro", "javascript", "typescript", "lua", "css", "html" },
